...
public enum States {
    ...
    SPENDING_EIDRPOU_SUBSCRIBE("Оберіть параметри оновлення"),
    SPENDING_EIDRPOU_DYNAMIC("Які дані необхідно відобразити"),
    SPENDING_EIDRPOU_DYNAMIC_EXPENSES("Динаміка витрат. Введіть ЕДРПОУ"),
    SPENDING_EIDRPOU_DYNAMIC_EXPENSES_REQUEST("Відправляємо запит …"),
    SPENDING_EIDRPOU_DYNAMIC_EXPENSES_RESPONSE("One more request ?"),
    SPENDING_EIDRPOU_DYNAMIC_INCOMES("Відправляємо запит …"),
