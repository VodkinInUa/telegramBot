...
public enum Events {
    ...
    TO_SPENDING_EIDRPOU_SUBSCRIBE("Підписатися на організацію"),
    TO_SPENDING_EIDRPOU_DYNAMIC("Динаміка витрат/надходжень"),
    TO_SPENDING_EIDRPOU_DYNAMIC_EXPENSES("Динаміка витрат"),
    TO_SPENDING_EIDRPOU_DYNAMIC_INCOMES("Динаміка надходжень"),
